...
const MainPage = () => {
    return (
        <div className={styles.container}>
            <div className={styles.flexItem, styles.leftPanel}><h1 className={styles.title}>Welcome to Peter Cooper Trading.</h1>
                <p>Peter Cooper Trading is a fund associated with the Cooper Union FinTech club. This fund aims to serve as an educational experience for students who are interested in financial technology.</p>
